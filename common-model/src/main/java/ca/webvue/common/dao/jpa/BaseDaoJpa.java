...
import ca.webvue.common.dao.IBaseDao;
import ca.webvue.common.entity.OrderEntity;
import ca.webvue.common.query.Filter;
import ca.webvue.common.query.Filter.Operator;
import ca.webvue.common.query.Order;
import ca.webvue.common.query.Order.Direction;
import ca.webvue.common.query.Page;
import ca.webvue.common.query.Pageable;

public abstract class BaseDaoJpa<T, ID extends Serializable> implements IBaseDao<T, ID> {
	/** 实体类类型 */
